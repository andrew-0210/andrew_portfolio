...
const Projects = () => {
  return (
    <div className='relative z-10 flex flex-col lg:flex-row gap-[2.5rem] overflow-x-auto w-full no-scrollbar px-5 lg:px-0'>
      {projects.map((proj, index) => {
        return (
          <Link
            href={proj.href}
            key={index}
            className='lg:min-w-[573px] min-w-[24rem] h-full gap-2 flex flex-col'
          >
